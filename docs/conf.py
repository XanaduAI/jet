...
# -*- coding: utf-8 -*-
#
# Jet documentation build configuration file, created by
...
for name in (
    ...
    class Mock(MagicMock):
        ...
        def __getattr__(cls, name):
            # Restore the names of the classes generated by the Python bindings.
            if name.endswith("C64") or name.endswith("C128"):
                return name
            return MagicMock()
...
breathe_projects = {"Jet": "./doxyoutput/xml"}
breathe_default_project = "Jet"
