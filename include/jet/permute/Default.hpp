...
class DefaultPermuter {
  ...
  public:
    ...
    static std::vector<DataType> Transpose(const std::vector<DataType> &data_,
...

    {
        ...
        std::vector<unsigned short int> small_map_old_to_new_position(blocksize);
    ...
    template <class DataType>
    static void Transpose(const std::vector<DataType> &data_,
                                    const std::vector<size_t> &shape,
